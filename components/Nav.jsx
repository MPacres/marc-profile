...
const NavLinks = () => {
  return (
    <>
      <Link href="/home" className="py-2 text-gray-700 md:text-red-200 md:underline md:hover:underline underline-offset-8">Home</Link>
      <Link href="/projects" className="py-2 md:hover:underline underline-offset-8">Projects</Link>
      <Link href="/about" className="py-2 md:hover:underline underline-offset-8 bg-p">About</Link>
    </>
  );
};
